        ...
        <div className="row text-center justify-content-center">
          ...
          <div className="col-xl-3 col-sm-6 m-5">
            <div className="bg-primary cards bg-opacity-10 rounded  py-5 px-4">
              ...
              />
              <h5 className="fw-bold text-primary mb-0">Pet Name</h5>
              <span className="small text-uppercase text-muted">Pet Id</span>
          ...
          <div className="col-xl-3 col-sm-6 m-5">
            <div className="bg-primary bg-opacity-10 rounded cards py-5 px-4">
              <img
                ...
                className="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm"
              />
              <h5 className="mb-0 fw-bold text-primary ">Pet Name</h5>
              <span className="small text-uppercase text-muted">Example 1</span>
              <ul className="social mb-0 list-inline mt-3">
                <li className="list-inline-item">
                  <a href="#" className="social-link">
                    <img
          ...
          <div className="col-xl-3 col-sm-6 m-5">
            <div className="bg-primary bg-opacity-10 rounded cards py-5 px-4">
              <img
                src="https://static.toiimg.com/photo/89246774.cms"
                alt=""
                width="200"
                className="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm"
              />
